...
public class EventoDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
            final String criaTabela = "CREATE TABLE IF NOT EXISTS  evento(id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT," + "valor REAL, imagem TXT, dataocorreu DATE, datacadastro DATE, datavalida DATE";
